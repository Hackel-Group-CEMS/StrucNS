...
OUTPUT_DIR="/scratch.global/hackelb/mulli468/Tsuboyama_analysis/processing_data/StructureNS_analysis/base_model"
...
python graphml_to_features_base_batch.py ${CHUNK_ID} ${TOTAL_CHUNKS}
